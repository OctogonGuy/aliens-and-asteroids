...
async def main():
    ...
    # Load sounds
    laser_sound = load_sound('laser.ogg')
    alien_kill_sound = load_sound('alien_kill.ogg')
    asteroid_kill_sound = load_sound('asteroid_kill.ogg')
    spaceship_kill_sound = load_sound('spaceship_kill.ogg')
